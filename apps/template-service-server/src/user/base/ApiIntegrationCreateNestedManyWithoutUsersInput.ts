...
@InputType()
class ApiIntegrationCreateNestedManyWithoutUsersInput {
...
export { ApiIntegrationCreateNestedManyWithoutUsersInput as ApiIntegrationCreateNestedManyWithoutUsersInput };
